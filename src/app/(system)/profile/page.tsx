    ...
    <div className="bg-[#F7F8FA] px-4 flex flex-col gap-4 pb-[90px] pt-[20px]">
      <div className="flex flex-col gap-2">
        ...
        <span className="flex items-center gap-1 font-medium text-primary/70 text-sm">
          <Avatar className="bg-primary text-white size-32">
            ...
            <span className="bg-amber-500 text-white px-4 py-1 rounded-full">Broker</span>
        </span>
        <span className="flex flex-col items-center gap-1 font-medium text-primary/70 text-sm">
          
            <span className="text-primary px-4 py-1 rounded-full  font-bold text-3xl ">John TheBroker</span>
                        <span className="text-neutral-700 font-medium text-lg px-4 py-1 rounded-full">rodney@networkcorp.net</span>
        </span>
      </div>
      ...
      <div className="w-full flex items-start justify-between">
        <div className="flex flex-col items-start">
          ...
          <div className="flex w-full bg-[#F7F8FA] rounded-2xl px-4 py-3">First Name</div>
