...
export default function Header() {
  ...
  return (
    <header className="w-full p-4 flex items-center justify-end gap-3 fixed top-6 xl:top-0 z-5 sm:p-6 xl:relative xl:bg-white xl:py-4 xl:justify-between xl:border-b">
      <MenuDesktop />
